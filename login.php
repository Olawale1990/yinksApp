    ...
    <body>
      ...
      <nav class="navbar navbar-inverse">
        ...
        <div class="container-fluid">
           ...
           <center>
       <form action=" " method="POST" enctype="text/plain" style="background-image:url(images/img2.jpg); border:3px solid blue;">
        <fieldset>
        <legend> Login Details:</legend>
        <label>Username:</label><input type="text" name="Uname" id="Uname" placeholder="firstname" required="required"/><span style="color:red;">*</span><br/><br/>
        
        <label>Email:</label><input type="text" name="email" id="email" placeholder="email"  required="required"/><span style="color:red;">*</span><br/><br/>
        <input type="submit" value="Place Order" name="sub" id="sub" style="margin-left:70px;"/> 
    </fieldset>
       </form>
       </center>
         </div>
         <div class="footer" style="width:100%;height:360px; background-color:rgba(0, 0, 0, 0.726); color:aliceblue;" >
          ...
          <div class="foot2" style="float:right; color:aquamarine; width:35%; height:230px; float:right;">Programming languages we teaches are:<br/>
           ...
           <center><div class="foot3" style=" width:30%; height:230px;">Ecommerce Website Developed by Yinkaprofessor, &copy; &reg; 2022 <a href="#">go to the top</a></div></center>
      </div>
